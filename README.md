...
# Что такое UVST?
UVST - Это бесплатный GULP сборщик проектов, разработанный unniiiverse. UVST обладает большим набором заготовок и плагинов, для самых разнообразных задач. Текущая версия UVST: uvst 1.1.4. 
...
+ Создание .woff и .woff2 шрифтов из .otf и .ttf. [#](#обработка-шрифтов)
...
# Начало работы
Для начала работы с UVST, необходимо установить **Node JS** [#](https://nodejs.org/en/download/), так же в терминал проекта необходимо ввести комманду ```npm run setup```.
...
```
После добавления плагина и его настроек, вы сможете подключать картинки из любого файла html с помощью: ```@img/[IMG SRC]```. Если не использовать этот плагин для указания путей, или изменить префикс, картинки могут не появится.
...
Не поддерживает файлы .otf, для обновления файла шрифтов необходимо мануально удалить файл **scss/base/fonts.scss**.
